...
#
#  Description: Example of usage of the Ca-AdEx neuron stimulated with continuous currents
#
...
dcgd = nest.Create('dc_generator', {'start': stimulusStart, 'stop': stimulusStop, 'amplitude': I_d})

nest.Connect(dcgs, cm, syn_spec={
    'synapse_model': 'static_synapse', 'weight': 1., 'delay': .1, 'receptor_type': 0})
nest.Connect(dcgd, cm, syn_spec={
    'synapse_model': 'static_synapse', 'weight': 1., 'delay': .1, 'receptor_type': 1})
