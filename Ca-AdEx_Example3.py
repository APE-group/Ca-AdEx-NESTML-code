...
for neuron_name in neuron_names:
    ...
    nest.Connect(sg1, cm, syn_spec={
        'synapse_model': 'static_synapse', 'weight': 1500, 'delay': 1.,
        'receptor_type': receptor_types['EXC_SPIKES_DISTAL']})
    ...
    nest.Connect(sg3, cm, syn_spec={
        'synapse_model': 'static_synapse', 'weight': 300, 'delay': 1., 'receptor_type': receptor_types['EXC_SPIKES_SOMA']})
    nest.Connect(sg3, cm, syn_spec={
        'synapse_model': 'static_synapse', 'weight': 50, 'delay': 1.,
        'receptor_type': receptor_types['SPIKES_AMPA_NMDA_D']})
    nest.Connect(sg4, cm, syn_spec={
        'synapse_model': 'static_synapse', 'weight': 100, 'delay': 1.,
        'receptor_type': receptor_types['SPIKES_AMPA_NMDA_D']})
    ...
    res_cm.append(nest.GetStatus(mm_cm, 'events')[0])
...
###############################################################################
plt.subplot(411)
plt.plot(res_cm[0]['times'], res_cm[0]['V_m_s'], c='b', label='v_m soma cm [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['V_m_s'], c='orange', ls="--", label='v_m soma cm')

plt.plot(res_cm[0]['times'], res_cm[0]['V_m_d'], c='g', label='v_m dist cm [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['V_m_d'], c='orange', ls="--", label='v_m dist cm')
...
plt.subplot(412)
plt.plot(res_cm[0]['times'], res_cm[0]['m_Ca'], c='b', lw=2., label='m [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['m_Ca'], c='orange', ls='--', lw=2., label='m')

plt.plot(res_cm[0]['times'], res_cm[0]['h_Ca'], c='r', lw=2., label='h [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['h_Ca'], c='orange', ls='--', lw=2., label='h')

plt.plot(res_cm[0]['times'], res_cm[0]['m_Ca'] * res_cm[0]['h_Ca'], c='k', lw=2., label='g [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['m_Ca'] * res_cm[1]['h_Ca'], c='orange', ls='--', lw=2., label='g')
...
plt.subplot(413)
plt.plot(res_cm[0]['times'], res_cm[0]['w'], c='b', lw=2., label='W cm [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['w'], c='orange', ls='--', lw=2., label='W cm')
#plt.legend()
plt.xlim(xlimStart, xlimEnd)
plt.ylabel('W')
...
plt.subplot(512)
plt.plot(res_cm[0]['times'], res_cm[0]['m_Ca'], c='b', lw=2., label='m_Ca [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['m_Ca'], c='orange', ls='--', lw=2., label='m_Ca')

plt.plot(res_cm[0]['times'], res_cm[0]['h_Ca'], c='r', lw=2., label='h_Ca [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['h_Ca'], c='orange', ls='--', lw=2., label='h_Ca')

plt.plot(res_cm[0]['times'], res_cm[0]['m_Ca'] * res_cm[0]['h_Ca'], c='k', lw=2., label='g_Ca [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['m_Ca'] * res_cm[1]['h_Ca'], c='orange', ls='--', lw=2., label='g_Ca')

plt.legend()
plt.xlim(xlimStart, xlimEnd)

plt.subplot(513)
plt.plot(res_cm[0]['times'], res_cm[0]['c_Ca'], c='b', label='[Ca] [conv]')
plt.plot(res_cm[1]['times'], res_cm[1]['c_Ca'], c='orange', ls='--', label='[Ca]')
...
plt.subplot(515)
plt.plot(res_cm[0]['times'], res_cm[0]['m_K'], c='b', lw=2., label='m_K')
plt.plot(res_cm[1]['times'], res_cm[1]['m_K'], c='orange', ls='--', lw=2., label='m_K')
